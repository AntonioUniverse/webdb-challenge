...
SQL is a querying language that allows the programmer to query data, while RDMS is something like mysql or postgres which help manage the data a programmer is trying to query. 

1. Why do tables need a `primary key`?
- it allows the programmer to establish relationships between tables--

1. What is the name given to a table column that references the primary key on another table. 
- it is called a foreign key--
1. What do we need in order to have a _many to many_ relationship between two tables.
-- we would need to create at third table that contains foreign keys for both tables. --
